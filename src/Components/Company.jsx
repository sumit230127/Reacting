      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center">
              <div className="rounded-lg shadow-xl overflow-hidden w-full max-w-md">
                <img src="/api/placeholder/600/400" alt="Future vision" className="w-full h-auto" />
              </div>
            </div>
            <div>
    ...
    <div className="bg-white p-6 rounded-lg">
      <div className="flex flex-wrap justify-between items-center">
        <div className="w-full md:w-1/5 text-center mb-4 md:mb-0">
          <img src="/api/placeholder/120/40" alt="Forbes logo" className="h-8 mx-auto" />
        </div>
        <div className="w-full md:w-1/5 text-center mb-4 md:mb-0">
          <img src="/api/placeholder/120/40" alt="Bloomberg logo" className="h-8 mx-auto" />
        </div>
        <div className="w-full md:w-1/5 text-center mb-4 md:mb-0">
          <img src="/api/placeholder/120/40" alt="Inc logo" className="h-8 mx-auto" />
        </div>
        <div className="w-full md:w-1/5 text-center mb-4 md:mb-0">
          <img src="/api/placeholder/120/40" alt="NPR logo" className="h-8 mx-auto" />
        </div>
        <div className="w-full md:w-1/5 text-center">
          <img src="/api/placeholder/120/40" alt="BusinessWeek logo" className="h-8 mx-auto" />
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="h-64 bg-gray-200 flex items-center justify-center">
                <img src="/api/placeholder/150/150" alt="Team member" className="rounded-full" />
              </div>
