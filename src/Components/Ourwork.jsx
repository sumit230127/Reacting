        ...
        >
          ...
          <div className="space-y-3">
            {services.map((service, index) => (
              <div
                key={index}
                className="flex items-center gap-3 p-3 border border-gray-300 rounded-lg bg-white shadow-sm transition hover:shadow-md cursor-pointer"
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {project.stats.map((stat, idx) => (
                    <div key={idx} className="text-center p-2 border border-gray-300 rounded-lg">
                      <h4 className="text-2xl font-bold">{stat.percentage}</h4>
