...
const Service = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 text-black">
      {/* Hero Section */}
      <div className="flex flex-col md:flex-row items-center py-20 px-6 md:px-20">
        <div className="md:w-1/2 space-y-6">
          ...
          <div className="flex space-x-4 mt-4">
            <img src={googlePartner} alt="Google Partner" className="h-8 md:h-10" />
            <img src={MetaLogo} alt="Meta Partner" className="h-8 md:h-10" />
            <img src={amazonAds} alt="Amazon Ads" className="h-8 md:h-10" />
            <img src={hubspot} alt="HubSpot" className="h-8 md:h-10" />
          </div>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center px-6 md:px-20 mt-20">
        {/* Text First */}
      ...
      <div className="flex flex-col md:flex-row items-center py-20 px-6 md:px-20">
        ...
        <div className="md:w-1/2 space-y-6">
          <h2 className="text-4xl ml-10 md:text-5xl font-bold">Transform Your Vision into a Stunning Online Reality</h2>
          <p className="text-base ml-10 md:text-lg">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between py-20 px-6 bg-white min-h-[800px]">
        {/* Left Section */}
        <div className="md:w-1/2">
          ...
          <div className="mt-10 flex items-center">
            <div className="text-green-700 text-4xl md:text-5xl font-bold">900+</div>
            <div className="ml-3 text-base md:text-lg">
      ...
      <div className="bg-gray-100 py-24 px-6 lg:px-20 flex flex-col lg:flex-row items-center min-h-[600px]">
        ...
        <div className="w-full lg:w-1/2 lg:pl-20 mt-14 lg:mt-0">
          ...
          <div className="flex flex-wrap mt-8 space-x-4">
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" alt="Google Partner" className="h-12 md:h-16"/>
            <img src="https://upload.wikimedia.org/wikipedia/commons/9/98/Microsoft_logo_%282012%29.svg" alt="Microsoft Partner" className="h-12 md:h-16"/>
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a7/Facebook_f_logo_%282019%29.svg" alt="Meta Partner" className="h-12 md:h-16"/>
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg" alt="Amazon Partner" className="h-12 md:h-16"/>
          </div>
        </div>
      </div>

      <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-16 min-h-[700px]">
        {/* Left Section */}
        <div className="md:w-1/2 text-left space-y-8">
          ...
          {/* Statistics */}
          <p className="text-green-700 font-extrabold text-4xl md:text-6xl mt-8">
            200% 
            <span className="text-gray-700 text-base md:text-3xl font-normal ml-2">
